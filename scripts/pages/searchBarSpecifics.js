...
function launchSearchSpecific (event) {
  ...
  if (clickedIcon === ingredientsListDownIcon) {
    ...
    if (!ingredientVisible) { ingredientsSearchList.classList.add('searchActive') } else { ingredientsSearchList.classList.remove('searchActive') }
    ...
    if (!appareilsVisible) { appareilsSearchList.classList.add('searchActive') } else { appareilsSearchList.classList.remove('searchActive') }
    ...
    if (!ustensilesVisible) { ustensilesSearchList.classList.add('searchActive') } else { ustensilesSearchList.classList.remove('searchActive') }
